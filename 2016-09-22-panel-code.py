...
#
#   Nathan A. Rooy
#   Inviscid Constant Strength Doublet Method Panel Code
...
##https://github.com/akidhruv/Constant-Strength-Doublet-Panel-Method/blob/master/Constant_Strength_Doublet_Method.py
